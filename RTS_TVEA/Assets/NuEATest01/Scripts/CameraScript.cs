...
public class CameraScript : MonoBehaviour {
    ...
    void MouseMovement()
    {
        ...
        if (Input.mousePosition.x >= screenRight.x&& !Input.GetKey("left alt") || Input.GetKey(KeyCode.A))
        {
        ...
        else if (Input.mousePosition.x <= screenLeft.x&& !Input.GetKey("left alt") || Input.GetKey(KeyCode.D))
        {
        ...
        //Move Y position
        if (Input.mousePosition.y >= screenTop.y && !Input.GetKey("left alt") || Input.GetKey(KeyCode.S))
        {
        ...
        else if (Input.mousePosition.y <= screenBottom.y && !Input.GetKey("left alt") || Input.GetKey(KeyCode.W))
        {
